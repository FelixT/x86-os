...
typedef struct window_settings_t {
   ...
   windowobj_t *d_bgcolourpick_wo;
   windowobj_t *d_bgimg_wo;
   windowobj_t *d_bgimgpick_wo;
   windowobj_t *w_bgcolour_wo;
   windowobj_t *w_bgcolourpick_wo;
   ...
   windowobj_t *theme_colourpick_wo;
   windowobj_t *theme_colour2_wo;
   windowobj_t *theme_colour2pick_wo;
   windowobj_t *theme_txtpadding_wo;
   windowobj_t *theme_fontpath_wo;
   windowobj_t *theme_fontpathpick_wo;
} window_settings_t;
