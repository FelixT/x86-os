...
export CFLAGS="-ffreestanding -O2 -Wall -Wextra -fno-exceptions -fno-common -mgeneral-regs-only -nostdlib -fno-strict-aliasing"
export CPPFLAGS="-ffreestanding -O2 -Wall -Wextra -fno-exceptions -fno-rtti -fno-common -mgeneral-regs-only -nostdlib -g -fno-strict-aliasing"

c_files="font gui terminal interrupts events tasks ata memory fat bmp elf paging windowmgr window draw lib/string api windowobj window_term window_settings window_popup cboot fs time futex shared pci msg"
o_files="o/start_32.o o/main.o o/cmain.o o/gui.o o/terminal.o o/irq.o o/interrupts.o o/events.o o/tasks.o o/ata.o o/memory.o o/fat.o o/bmp.o o/elf.o o/paging.o o/windowmgr.o o/window.o o/font.o o/draw.o o/lib/string.o o/api.o o/windowobj.o o/window_term.o o/window_settings.o o/window_popup.o o/fs.o o/time.o o/futex.o o/shared.o o/pci.o o/msg.o"
